...
/* These constants define some elf machine types */
...
typedef struct elf64_hdr {
    ...
    Elf64_Half e_shstrndx;  /* Index of the section entry that contains the section names */
} Elf64_Ehdr;
 ...
 * Note that before you attempt to access the name of a section, you should
 * first check that the section has a name (The offset given by sh_name is
 * not equal to SHN_UNDEF)
 * */
